...
public class LogActivity
{
    ...
    [Function("LogOn")]
    public async Task<IActionResult> LogOn([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post"
        ,Route="api/LogOn")] HttpRequest req)
    {
    ...
    [Function("LogOff")]
    public async Task<IActionResult> LogOff([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post"
        ,Route="api/LogOff")] HttpRequest req)
    {
    ...
    public async Task<IActionResult> UpdatedActivity([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post"
        ,Route="api/UpdatedActivity")] HttpRequest req)
    {
    ...
    public async Task<IActionResult> GetActiveSession([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post"
        ,Route= "api/GetActiveSession")] HttpRequest req)
    {
